...
import edu.smartschool.repository.RegionRepository;
import edu.smartschool.repository.search.RegionSearchRepository;
...
public class RegionResourceIntTest {
    ...
    public void initTest() {
        region = new Region();
        region.setIntitule(DEFAULT_INTITULE);
    }
    ...
    public void createRegion() throws Exception {
        ...
        assertThat(testRegion.getIntitule()).isEqualTo(DEFAULT_INTITULE);
    }
    ...
    public void updateRegion() throws Exception {
        ...
        // Update the region
        region.setIntitule(UPDATED_INTITULE);
        ...
        Region testRegion = regions.get(regions.size() - 1);
        assertThat(testRegion.getIntitule()).isEqualTo(UPDATED_INTITULE);
    }
