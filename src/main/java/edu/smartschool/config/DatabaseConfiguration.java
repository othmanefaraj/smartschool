package edu.smartschool.config;

import edu.smartschool.config.liquibase.AsyncSpringLiquibase;
...
@Configuration
@EnableJpaRepositories("edu.smartschool.repository")
@EnableJpaAuditing(auditorAwareRef = "springSecurityAuditorAware")
@EnableTransactionManagement
@EnableElasticsearchRepositories("edu.smartschool.repository.search")
